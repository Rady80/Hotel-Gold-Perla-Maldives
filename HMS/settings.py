...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Místo pro globální šablony (pokud nějaké máte)
        'APP_DIRS': True, # Toto musí být nastaveno na True, aby Django našlo šablony uvnitř aplikací
        'OPTIONS': {
            'context_processors': [
